...
[![R](https://img.shields.io/badge/R-%3E%3D%204.2-blue)](https://www.r-project.org/) [![License](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE) ![Status](https://img.shields.io/badge/status-research%20code-orange)
...
👉 [Click here to view the full analysis](https://joaopspavan.github.io/LimaBean/Codes/LimaBean_.html)
## Authors
...
-   Lines **L20, L27, L21, L06, and L13** were selected as ideotypes combining **high yield**, **stability**, and **overall multi-trait performance**, supporting cultivation under contrasting edaphoclimatic conditions.
...
![Lima bean multi-trait / G×E results](Plots/limabeans.jpg)
